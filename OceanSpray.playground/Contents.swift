...
* mobile device.
* Progam your own shader function in `whenItsRaining` in ThunderOnlyHappens.metal. You
...
do {
  let path = Bundle.main.path(forResource: "ThunderOnlyHappens", ofType: "metal")
...
renderer.functionName = "whenItsRaining"
